...
def play_welcome_sound():
        pygame.mixer.init()
        pygame.mixer.music.load("C:\\Users\\DELL\\OneDrive\\Desktop\\project final\\welcome.mp3")  # Adjust path if necessary
...
def main():
    ...
    if ret:
        ...
        if facial_recognition_authorized and authorized:
            ...
            subprocess.Popen(["streamlit", "run", "C:\\Users\\DELL\\OneDrive\\Desktop\\project final\\Siren.py"])
